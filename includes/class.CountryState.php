...
class CountryState
{
	...
	public static function getAllCountries($key = '')
	{
		if ($key != '') {
			return CountryState::$countries[$key];
		} else {
	...
	public static function getCountryStates($_countryCode = "", $key = '')
	{
		if ($_countryCode != "" && isset(CountryState::$states[$_countryCode])) {
			if ($key != '') {
				return CountryState::$states[$_countryCode][$key];
			} else {
				return CountryState::$states[$_countryCode];
			}
		} else {
			return array();
		}
